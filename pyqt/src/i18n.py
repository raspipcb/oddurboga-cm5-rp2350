...
TRANSLATIONS = {
    "en": {
        ...
        "home.action.stop.sub": "mixed water in",
        "home.action.start.title": "Start",
        "home.action.start.sub": "mixed water in",
        "home.action.drain.title": "Drain",
        "home.action.drain.sub": "to sewer",
        ...
        "settings.threshold": "Reheat margin",
        "settings.extra_heat": "Inlet offset",
        "settings.sensors": "Temperature sensors",
        "settings.sensor_pot": "Tub",
        "settings.sensor_control": "Inlet",
        "settings.sensor_outdoor": "Outdoor",
        ...
        "api.inlet_offset": "Inlet offset",
        "api.reheat_hyst": "Reheat margin",
        "api.recover": "Safety recover",
        "api.status": "Status",
    ...
    "is": {
        ...
        "home.action.stop.sub": "blandað vatn inn",
        "home.action.start.title": "Hefja",
        "home.action.start.sub": "blandað vatn inn",
        "home.action.drain.title": "Tæma",
        "home.action.drain.sub": "í frárennsli",
        ...
        "settings.threshold": "Endurhitunarmörk",
        "settings.extra_heat": "Inntaksjöfnun",
        "settings.sensors": "Hitaskynjarar",
        "settings.sensor_pot": "Pottinn",
        "settings.sensor_control": "Inntak",
        "settings.sensor_outdoor": "Úti",
        ...
        "api.inlet_offset": "Inntaksjöfnun",
        "api.reheat_hyst": "Endurhitunarmörk",
        "api.recover": "Öryggisendurheimt",
        "api.status": "Staða",
